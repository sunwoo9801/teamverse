...
.e-calendar .e-header .e-title:focus {
  -webkit-box-shadow: 0 0 0 1px var(--color-sf-text-quarterary);
          box-shadow: 0 0 0 1px var(--color-sf-text-quarterary);
  background: none;
  text-decoration: none;
}
...
.e-calendar .e-header .e-prev:hover > span, .e-calendar .e-header .e-next:hover > span {
  border: var(--color-sf-bg-secondary-hover);
  color: var(--color-sf-text-secondary);
  cursor: pointer;
}
.e-calendar .e-header .e-prev:hover, .e-calendar .e-header .e-next:hover {
...
.e-calendar .e-content td.e-today span.e-day, .e-calendar .e-content td.e-focused-date.e-today span.e-day {
  ...
  border: none;
  border-radius: 30px;
  -webkit-box-shadow: inset 1px 0 var(--color-sf-brand-solid-primary), inset 0 1px var(--color-sf-brand-solid-primary), inset -1px 0 var(--color-sf-brand-solid-primary), inset 0 -1px var(--color-sf-brand-solid-primary);
          box-shadow: inset 1px 0 var(--color-sf-brand-solid-primary), inset 0 1px var(--color-sf-brand-solid-primary), inset -1px 0 var(--color-sf-brand-solid-primary), inset 0 -1px var(--color-sf-brand-solid-primary);
...
*.e-control-wrapper .e-input-group-icon.e-date-icon:focus {
  background: var(--color-sf-utility-secondary-text-color-hover);
  border-radius: 50%;
}
...
.e-datepicker .e-model-header {
  background-color: var(--color-sf-fg-secondary);
...
.e-daterangepicker.e-popup .e-footer {
  -webkit-box-align: center;
      -ms-flex-align: center;
          align-items: center;
  border-top: 1px solid var(--color-sf-bg-primary-alt);
  clear: both;
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.e-daterangepicker.e-popup .e-date-range-container.e-range-border {
  border-right: 1px solid var(--color-sf-bg-primary-alt);
}
...
.e-daterangepicker.e-rtl .e-date-range-container.e-range-border {
  border-left: 1px solid var(--color-sf-bg-primary-alt);
  border-right: 0;
}
...
*.e-device.e-daterangepicker.e-range-modal {
  background-color: rgba(var(--color-sf-bg-secondary-hover), 0.6);
  height: 100%;
  left: 0;
  opacity: 0.5;
  pointer-events: auto;
