...
.e-gantt.e-gantt-rtl .e-connector-line-right-arrow {
  ...
  border-right-color: var(--color-sf-brand-primary);
}
...
.e-gantt.e-gantt-rtl .e-gantt-chart .e-timeline-header-container {
  ...
  border-left-color: var(--color-sf-border-secondary) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-gantt .e-verticallines .e-cloneproperties.e-draganddrop .e-rowdragdrop, .e-gantt .e-bothlines .e-cloneproperties.e-draganddrop .e-rowdragdrop {
  border-bottom: 0;
  border-right: 1px solid var(--color-sf-border-primary);
  border-top: 1px solid var(--color-sf-border-primary);
}
...
.e-gantt .e-gantt-chart .e-chart-root-container .e-content td.e-chart-row-cell.e-dropbottom {
  ...
  -webkit-box-shadow: var(--color-sf-brand-primary);
          box-shadow: var(--color-sf-brand-primary);
}
...
.e-gantt .e-gantt-chart .e-manualparent-milestone-top,
.e-gantt .e-gantt-chart .e-manualparent-milestone-bottom {
  border-bottom-color: var(--color-sf-bg-secondary-alt);
}
.e-gantt .e-gantt-chart .e-gantt-manualparenttaskbar-right {
  cursor: e-resize;
  margin-left: -8px;
...
.e-predecessor-tooltip {
  background-color: var(--color-sf-base-black) !important; /* stylelint-disable-line declaration-no-important */
  border-color: var(--color-sf-base-black) !important; /* stylelint-disable-line declaration-no-important */
  visibility: hidden;
}
.e-predecessor-tooltip .e-arrow-tip-outer.e-tip-bottom {
  border-top: 8px solid var(--color-sf-base-black);
}
.e-predecessor-tooltip .e-arrow-tip-inner.e-tip-bottom {
  color: var(--color-sf-base-black);
}
.e-predecessor-tooltip .e-left-btn:disabled,
.e-predecessor-tooltip .e-right-btn:disabled {
  color: var(--color-sf-bg-secondary-alt) !important;
}
...
.e-gantt .e-cloneproperties.e-draganddrop {
  -webkit-box-shadow: 0 3px 8px 0 rgba(var(--color-sf-base-black), 0.26);
          box-shadow: 0 3px 8px 0 rgba(var(--color-sf-base-black), 0.26);
  opacity: 0.95;
  overflow: visible;
}
.e-gantt .e-cloneproperties {
...
.e-gantt .e-grid .e-focused:not(.e-menu-item) {
  -webkit-box-shadow: 0 0 0 1px var(--color-sf-border-primary) inset !important;
          box-shadow: 0 0 0 1px var(--color-sf-border-primary) inset !important; /* stylelint-disable-line declaration-no-important */
}
.e-gantt .e-temp-content,
...
.e-gantt .e-gantt-chart .e-active-container {
  outline-color: var(--color-sf-border-primary);
}
.e-gantt .e-gantt-chart .e-gantt-child-taskbar-inner-div {
  background: var(--color-sf-utility-primary-light);
  outline: 1px solid var(--color-sf-brand-primary);
  border-radius: 4px;
}
...
.e-gantt .e-gantt-chart .e-gantt-parent-taskbar-inner-div {
  outline: 1px solid var(--color-sf-border-primary-alt);
}
.e-gantt .e-gantt-chart .e-gantt-parent-taskbar-inner-div {
...
.e-gantt .e-gantt-chart .e-gantt-child-manualtaskbar {
  background: var(--color-sf-utility-success-light);
  outline: 1px solid var(--color-sf-utility-success);
}
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar.e-gantt-child-manualtaskbar {
  background: -webkit-gradient(linear, left top, right top, from(var(--color-sf-utility-success-light)), color-stop(30%, var(--color-sf-utility-success)), color-stop(70%, var(--color-sf-utility-success)), color-stop(70%, var(--color-sf-utility-success)), to(var(--color-sf-utility-success-light)));
  background: linear-gradient(to right, var(--color-sf-utility-success-light), var(--color-sf-utility-success) 30%, var(--color-sf-utility-success) 70%, var(--color-sf-utility-success) 70%, var(--color-sf-utility-success-light) 100%);
}
...
.e-gantt .e-gantt-chart .e-rangecontainer .e-rg-rangdiv {
  border: 2px solid var(--color-sf-border-warning);
  width: 5px;
  z-index: 6;
}
.e-gantt .e-gantt-chart .e-event-markers {
...
.e-gantt .e-gantt-chart .e-event-markers .e-gantt-right-arrow {
  border-right-color: var(--color-sf-utility-warning-light);
  border-left-color: var(--color-sf-utility-warning-light) !important; /* stylelint-disable-line declaration-no-important */
}
.e-gantt .e-gantt-chart .e-gantt-unscheduled-taskbar {
  background: -webkit-gradient(linear, left top, right top, from(var(--color-sf-utility-primary-light)), color-stop(30%, var(--color-sf-brand-primary)), color-stop(70%, var(--color-sf-brand-primary)), color-stop(70%, var(--color-sf-brand-primary)), to(var(--color-sf-utility-primary-light)));
  background: linear-gradient(to right, var(--color-sf-utility-primary-light), var(--color-sf-brand-primary) 30%, var(--color-sf-brand-primary) 70%, var(--color-sf-brand-primary) 70%, var(--color-sf-utility-primary-light) 100%);
  border: 0px;
  border-radius: 2px;
}
...
.e-gantt .e-gantt-chart .e-unscheduled-milestone-bottom {
  border-top-color: var(--color-sf-bg-secondary-alt);
}
.e-gantt .e-gantt-chart .e-progress-resize-gripper .e-progressbar-handler {
  background: var(--color-sf-text-primary);
}
.e-gantt .e-gantt-chart .e-progress-resize-gripper .e-progressbar-handler-after {
  border-bottom-color: var(--color-sf-text-primary);
}
...
.e-gantt .e-gantt-chart .e-critical-line {
  stroke: var(--color-sf-utility-danger);
}
.e-gantt .e-gantt-chart .e-connector-line-arrow {
  fill: var(--color-sf-brand-primary);
}
.e-gantt .e-gantt-chart .e-critical-line-arrow {
  fill: var(--color-sf-utility-danger);
}
.e-gantt .e-gantt-chart .e-connector-line-right-arrow {
  border-left-color: var(--color-sf-brand-primary);
}
...
.e-gantt .e-gantt-chart .e-connector-line-hover {
  border-color: var(--color-sf-brand-primary);
  outline-color: var(--color-sf-brand-primary);
}
...
.e-gantt .e-gantt-chart .e-connectorpoint-left-hover,
.e-gantt .e-gantt-chart .e-connectorpoint-right-hover {
  background-color: var(--color-sf-brand-primary-d10);
  border-color: var(--color-sf-bg-primary);
}
.e-gantt .e-gantt-chart .e-connectorpoint-left-hover:hover,
.e-gantt .e-gantt-chart .e-connectorpoint-right-hover:hover {
  background-color: var(--color-sf-fg-secondary-hover);
  border-color: var(--color-sf-bg-primary);
}
.e-gantt .e-gantt-chart .e-left-label-inner-div,
.e-gantt .e-gantt-chart .e-right-label-inner-div {
...
.e-gantt .e-gantt-chart .e-downtail::after {
  border-top-color: var(--color-sf-on-brand-solid-primary);
}
.e-gantt .e-gantt-chart .e-downtail::before {
  border-top-color: var(--color-sf-border-secondary);
}
.e-gantt .e-gantt-chart .e-ganttpopup .e-content {
  background-color: var(--color-sf-on-brand-solid-primary);
  border-color: var(--color-sf-border-secondary);
}
...
.e-gantt .e-grid .e-icons:not(.e-stop):not(.e-check):not(.e-icon-left):not(.e-date-icon) {
  color: var(--color-sf-text-tertiary) !important; /* stylelint-disable-line declaration-no-important */
}
...
.e-gantt .e-gantt-chart .e-criticalconnector-line-right-arrow {
  border-left-color: var(--color-sf-utility-danger);
}
.e-gantt .e-gantt-chart .e-criticalconnector-line-left-arrow {
  border-right-color: var(--color-sf-utility-danger);
}
.e-gantt .e-gantt-chart .e-critical-connector-line-hover {
  border-color: var(--color-sf-utility-danger-light);
  outline-color: var(--color-sf-utility-danger-light);
}
.e-gantt .e-gantt-chart .e-critical-connector-line-right-arrow-hover {
  border-left-color: var(--color-sf-utility-danger-light);
}
.e-gantt .e-gantt-chart .e-critical-connector-line-left-arrow-hover {
  border-right-color: var(--color-sf-utility-danger-light);
}
.e-gantt .e-gantt-chart .e-gantt-child-critical-taskbar-inner-div {
  background: var(--color-sf-utility-danger-light);
  outline: 1px solid var(--color-sf-utility-danger-light);
  border-radius: 4px;
}
...
.e-gantt .e-gantt-chart .e-gantt-critical-unscheduled-taskbar {
  background: -webkit-gradient(linear, left top, right top, from(rgba(255, 85, 85, 0.2)), color-stop(30%, var(--color-sf-utility-danger)), color-stop(70%, var(--color-sf-utility-danger)), color-stop(70%, var(--color-sf-utility-danger)), to(rgba(255, 85, 85, 0.2)));
  background: linear-gradient(to right, rgba(255, 85, 85, 0.2), var(--color-sf-utility-danger) 30%, var(--color-sf-utility-danger) 70%, var(--color-sf-utility-danger) 70%, rgba(255, 85, 85, 0.2) 100%);
...
.e-gantt-chart-resize-indicator {
  border: 1px dashed var(--color-sf-utility-primary-light);
  border-bottom: none;
  border-top: none;
}
...
.e-bigger .e-gantt .e-gantt-chart .e-connectorpoint-right-hover:hover {
  background-color: var(--color-sf-brand-primary-d10);
  border-color: var(--color-sf-bg-primary);
  outline: 2px solid var(--color-sf-utility-primary-light);
}
