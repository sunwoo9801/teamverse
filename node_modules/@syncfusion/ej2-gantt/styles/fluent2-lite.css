...
.e-gantt .e-grid .e-focused:not(.e-menu-item) {
  -webkit-box-shadow: 0 0 0 1px var(--color-sf-border-alt) inset !important;
          box-shadow: 0 0 0 1px var(--color-sf-border-alt) inset !important; /* stylelint-disable-line declaration-no-important */
}
.e-gantt .e-temp-content,
