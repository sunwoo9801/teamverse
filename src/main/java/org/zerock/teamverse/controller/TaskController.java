...
//   // List<FileInfo> files = fileInfoRepository.findAllById(taskDTO.getFileIds());
//   // task.setFiles(files);
//   // files.forEach(file -> file.setTask(task));
//   // }

//   // Task createdTask = taskService.createTask(task);
//   // messagingTemplate.convertAndSend("/topic/tasks", createdTask); // 작업 생성 이벤트
//   // 전송
